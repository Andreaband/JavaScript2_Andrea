  ...
  return (
    <div className="bg-[#FAF5F0] min-h-screen">
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-12">
            <div>
              ...
              <p className="text-red-600 font-light">
                The terra collection is a tribute to the raw beauty of the
                natural world, crafted to bring the essence of untouched
                landscapes into your dining experience. Each piece in the
                collection, from plates to bowls and cups, is glazed and
                textured to reflect the earthy elements of rock, moss, and
                pristine soil.
              </p>
            </div>
            ...
            <div>
              <p className="text-red-600">
                ...
                exercitationem, rerum cum reprehenderit delectus mollitia
                deserunt perspiciatis illo ab, non doloremque accusantium
                consequuntur vitae suscipit explicabo nihil! Eveniet perferendis
                iste dolorum, exercitationem facilis deserunt ipsum pariatur
                libero amet dolore cupiditate temporibus nisi provident
                molestias.
              </p>
            </div>
          </div>
        ...
        <div className="h-[500px] overflow-y-auto scrollbar-thin scrollbar-thumb-red-500 w-full">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-1 w-full">
            {products.map((product) => (
              ...
              >
                ...
                />
                <h2 className="text-xl font-semibold mt-2 text-red-700">
                  {product.name}
                </h2>
